...
import pandas as pd
# import schemas
import convert_local_files_to_csv as ext
...
# testing if DRE file schema is correct
def gettingDREschemas():
# ,dtype=schemas.dre,na_values=schemas.dreNA
    fileList = ext.FindDREfiles('DRE')
